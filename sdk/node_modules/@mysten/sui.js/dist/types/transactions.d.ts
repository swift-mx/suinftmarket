...
export declare const SuiChangeEpoch: import("superstruct").Struct<{
    ...
    storage_rebate: import("superstruct").Struct<number | undefined, null>;
...
export declare const SuiConsensusCommitPrologue: import("superstruct").Struct<{
    ...
    checkpoint_start_timestamp_ms: import("superstruct").Struct<number, null>;
}>;
...
export declare const MoveCall: import("superstruct").Struct<{
    ...
    arguments: import("superstruct").Struct<unknown[] | undefined, import("superstruct").Struct<unknown, null>>;
}>;
...
export type TransactionKindName = 'TransferObject' | 'Publish' | 'Call' | 'TransferSui' | 'ChangeEpoch' | 'ConsensusCommitPrologue' | 'Pay' | 'PaySui' | 'PayAllSui' | 'Genesis';
...
export declare const TransactionEffects: import("superstruct").Struct<{
     ...
     * */
    executedEpoch: import("superstruct").Struct<number | undefined, null>;
...
export declare const SuiTransactionResponse: import("superstruct").Struct<{
    ...
    timestamp_ms: import("superstruct").Struct<number | null | undefined, null>;
    timestampMs: import("superstruct").Struct<number | null | undefined, null>;
    checkpoint: import("superstruct").Struct<number | null | undefined, null>;
...
export declare function getTransactionSignature(tx: SuiTransactionResponse | CertifiedTransaction): string[];
export declare function getTransactionData(tx: CertifiedTransaction): SuiTransactionData;
export declare function getTransactionSender(tx: SuiTransactionResponse): SuiAddress;
export declare function getGasData(tx: CertifiedTransaction | SuiTransactionResponse): SuiGasData;
export declare function getTransactionGasObject(tx: SuiTransactionResponse | CertifiedTransaction): SuiObjectRef;
export declare function getTransactionGasPrice(tx: SuiTransactionResponse | CertifiedTransaction): number;
export declare function getTransactionGasBudget(tx: SuiTransactionResponse | CertifiedTransaction): number;
...
export declare function getConsensusCommitPrologueTransaction(data: SuiTransactionKind): SuiConsensusCommitPrologue | undefined;
export declare function getTransactions(data: SuiTransactionResponse): SuiTransactionKind[];
