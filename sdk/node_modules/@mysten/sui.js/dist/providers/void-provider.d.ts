...
export declare class VoidProvider extends Provider {
    ...
    executeTransaction(_txnBytes: Uint8Array, _signature: SerializedSignature, _requestType: ExecuteTransactionRequestType): Promise<SuiExecuteTransactionResponse>;
    devInspectTransaction(_sender: SuiAddress, _txn: UnserializedSignableTransaction | string | Uint8Array, _gasPrice?: number | null, _epoch?: number | null): Promise<DevInspectResults>;
    ...
    getDynamicFieldObject(_parent_object_id: ObjectId, _name: string | DynamicFieldName): Promise<GetObjectDataResponse>;
