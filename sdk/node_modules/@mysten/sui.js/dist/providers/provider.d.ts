...
export declare abstract class Provider {
     ...
     */
    abstract getCoins(owner: SuiAddress, coinType: string | null, cursor: ObjectId | null, limit: number | null): Promise<PaginatedCoins>;
    /**
     * Get all Coin objects owned by an address.
     * @param cursor optional paging cursor
     * @param limt maximum number of items per page
     */
    abstract getAllCoins(owner: SuiAddress, cursor: ObjectId | null, limit: number | null): Promise<PaginatedCoins>;
    /**
     * Get the total coin balance for one coin type, owned by the address owner.
     * @param coinType optional fully qualified type names for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::sui::SUI if not specified.
     */
    abstract getBalance(owner: SuiAddress, coinType: string | null): Promise<CoinBalance>;
    /**
     ...
     */
    abstract getCoinBalancesOwnedByAddress(address: string, typeArg?: string): Promise<GetObjectDataResponse[]>;
    /**
     ...
     */
    abstract selectCoinsWithBalanceGreaterThanOrEqual(address: string, amount: bigint, typeArg: string, exclude: ObjectId[]): Promise<GetObjectDataResponse[]>;
    /**
     ...
     */
    abstract getTransactions(query: TransactionQuery, cursor: TransactionDigest | null, limit: number | null, order: Order): Promise<PaginatedTransactionDigests>;
    /**
     ...
     * Gateway
     */
    abstract executeTransaction(txnBytes: Uint8Array | string, signature: SerializedSignature, requestType: ExecuteTransactionRequestType): Promise<SuiExecuteTransactionResponse>;
    /**
     ...
     */
    abstract getEvents(query: EventQuery, cursor: EventId | null, limit: number | null, order: Order): Promise<PaginatedEvents>;
    /**
     ...
     * in the Sui System State object
     */
    abstract devInspectTransaction(sender: SuiAddress, txn: UnserializedSignableTransaction | string | Uint8Array, gasPrice: number | null, epoch: number | null): Promise<DevInspectResults>;
    /**
     ...
     */
    abstract getDynamicFieldObject(parent_object_id: ObjectId, name: string | DynamicFieldName): Promise<GetObjectDataResponse>;
    /**
     ...
     */
    abstract getCheckpointSummary(sequenceNumber: number): Promise<CheckpointSummary>;
    /**
     * Returns checkpoint summary based on a checkpoint digest
     * @param digest - The checkpoint digest
     */
    abstract getCheckpointSummaryByDigest(digest: CheckpointDigest): Promise<CheckpointSummary>;
    /**
     ...
     */
    abstract getCheckpointContents(sequenceNumber: number): Promise<CheckpointContents>;
    /**
     * Returns checkpoint summary based on a checkpoint content digest
     * @param digest - The checkpoint summary digest
     */
    abstract getCheckpointContentsByDigest(digest: CheckPointContentsDigest): Promise<CheckpointContents>;
    /**
