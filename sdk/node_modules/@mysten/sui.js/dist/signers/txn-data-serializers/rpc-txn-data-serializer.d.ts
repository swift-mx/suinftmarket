import { TxnDataSerializer, UnserializedSignableTransaction, TransactionBuilderMode } from './txn-data-serializer';
/**
...
export declare class RpcTxnDataSerializer implements TxnDataSerializer {
    ...
    serializeToBytes(signerAddress: string, unserializedTxn: UnserializedSignableTransaction, mode?: TransactionBuilderMode): Promise<Uint8Array>;
}
