...
import { ExecuteTransactionRequestType, FaucetResponse, SuiAddress, SuiExecuteTransactionResponse, TransactionEffects, DevInspectResults } from '../types';
import { Signer } from './signer';
import { MoveCallTransaction, MergeCoinTransaction, PayTransaction, PaySuiTransaction, PayAllSuiTransaction, SplitCoinTransaction, TransferObjectTransaction, TransferSuiTransaction, TxnDataSerializer, PublishTransaction, SignableTransaction, UnserializedSignableTransaction, SignedTransaction } from './txn-data-serializers/txn-data-serializer';
export declare abstract class SignerWithProvider implements Signer {
     ...
     */
    signMessage(message: Uint8Array): Promise<SerializedSignature>;
    /**
     * Sign a transaction.
     */
    signTransaction(transaction: Uint8Array | SignableTransaction): Promise<SignedTransaction>;
    /**
     * Sign a transaction and submit to the Fullnode for execution.
     */
    signAndExecuteTransaction(transaction: Uint8Array | SignableTransaction, requestType?: ExecuteTransactionRequestType): Promise<SuiExecuteTransactionResponse>;
    getTransactionDigest(tx: Uint8Array | SignableTransaction): Promise<string>;
    /**
     ...
     * in the Sui System State object
     */
    devInspectTransaction(tx: UnserializedSignableTransaction | string | Uint8Array, gasPrice?: number | null, epoch?: number | null): Promise<DevInspectResults>;
    /**
     * Dry run a transaction and return the result.
     * @param tx the transaction as SignableTransaction or string (in base64) that will dry run
     * @returns The transaction effects
     */
    dryRunTransaction(tx: SignableTransaction | string | Uint8Array): Promise<TransactionEffects>;
    /**
     *
