import { getObjectFields, JsonRpcProvider, RpcTxnDataSerializer, Connection } from '@mysten/sui.js';
...
class SDK {
    ...
    constructor(networkConfiguration) {
        ...
        this._serializer = new RpcTxnDataSerializer(this._jsonRpcProvider.connection.fullnode, this._jsonRpcProvider.options.skipDataValidation);
...
export { DEVNET_CONFIG, MarketMoudle, NetworkConfiguration, SDK };
